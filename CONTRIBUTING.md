# Contributing to sentra
  ...
  Thank you for your interest in sentra. This repository is part of the [SZL Holdings](https://github.com/szl-holdings) platform — governed AI decision infrastructure for regulated enterprises.

  ## Contribution model

  sentra is **source-available, proprietary software**. The codebase is published for evaluation, audit, and reference. We do not accept unsolicited pull requests at this time. See the repository [`LICENSE`](./LICENSE) for the full grant.
